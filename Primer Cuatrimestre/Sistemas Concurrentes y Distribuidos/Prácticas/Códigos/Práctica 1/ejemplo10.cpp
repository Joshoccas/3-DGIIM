...
const long  num_iters  = 800000000l ; // debe ser menor que la mitad del máximo entero (menor que 10^9 aprox)
...
int main()
{
  ...
  // incrementos concurrentes del contador atómico
  contador_atom = 0 ;
  ...
  // incrementos concurrentes del contador no atómico
  ...
  duration<float,milli> 
       tiempo_atom    = fin_atom  - inicio_atom ,
